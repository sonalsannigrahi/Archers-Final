...
StartScreen::StartScreen(){
    ...
    ////startButton.setWindow(window);
    ////settingsButton.setWindow(window);
    ////infoButton.setWindow(window);
    ////exitButton.setWindow(window);
    menu.setWindow(window);
    menu.setSize(gameConstants.WINDOW_WIDTH, gameConstants.WINDOW_HEIGHT);
    ...
    //startButton.setSize(gameConstants.WINDOW_WIDTH, gameConstants.WINDOW_HEIGHT);
...
void StartScreen::removeBird(int id){
    if (birds.size() > id){
        delete birds[id];
...
void StartScreen::createBalloon(){
...
void StartScreen::removeBalloon(int id){
    if (balloons.size() > id){
        delete balloons[id];
...
void StartScreen::createFireworks(){
...
void:: StartScreen::removeFireworks(int id){
